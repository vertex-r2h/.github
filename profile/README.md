...
## Quick Links
- [System Design (Draw.io)](https://app.diagrams.net/) - Sơ đồ kiến trúc Microservices & Flow logic hệ thống.
- [UI/UX Design (Figma)](https://www.figma.com/) - Giao diện Console UI, Admin Dashboard & Branding.
